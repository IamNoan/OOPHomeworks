 #include<iostream> 
    ...
    int main() { 
        ...
        if (rec.IsInside(pos3))
         ...
         Point mypoint;
         if (!mypoint.InitMembers(0, 78))
             cout << "mypoint: Failure of Init" << endl;

         Point myotherpoint;
         if (!myotherpoint.InitMembers(12, 69))
             cout << "myotherpoint: Failure of Init" << endl;

         Rectangle myrectangle;
         if (!myrectangle.InitMembers(myotherpoint, mypoint))
             cout << "myrectangle: Failure of Init" << endl;
         myrectangle.ShowRecInfo();
